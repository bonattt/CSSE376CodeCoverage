...
{	
	...
	ServiceLocator.Instance().AddDiscount(new Discount(1, 9999999));
	ServiceLocator.Instance().AddDiscount(new Discount(-90, 10));
	...
	@Test
	public void TestBookWithDoubleMileLessThanFiveThousand(){
		Car car = new Car(3);
